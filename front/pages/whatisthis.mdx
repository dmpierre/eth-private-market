...
We conclude by describing a setup where users can trustlessly sell execution of transactions themselves on Ethereum, laying out a potential construction of *stealth transactions*. Interestingly, this setup could be generalized to any kind of contract interactions - aka _stealth interactions_.
