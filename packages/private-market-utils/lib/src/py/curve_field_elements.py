'''
MODIFIED FROM https://github.com/ethereum/py_pairing/blob/master/py_ecc/bn128/bn128_field_elements.py
'''
...
# F_{q^2} = F_q[u] / (u^2 + 1)
# F_{q^6} = F_{q^2}[v] / (v^3 - u - 1)
# F_{q^12} = F_{q^6}[w] / (w^2 - v)
# so F_{q^12} = F_q[t] / (t^12 - 2t^6 + 2)
